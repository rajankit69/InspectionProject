...
import framework.AppController;
...
public class CropImageActivity extends AppCompatActivity
  ...
  public static void cropImageActivity(Application application) {
    AppController appController = new AppController(application);
  ...
  public boolean onPrepareOptionsMenu(Menu menu) {
    ...
    MenuItem done = menu.findItem(R.id.crop_image_menu_crop);
   cancel.setTitle(Utility.getLocalString(this,R.string.cancel));
   done.setTitle(Utility.getLocalString(this,R.string.done));
