...
public class RecordVideoPostsActivity extends Activity implements SurfaceHolder.Callback, OnClickListener {
    ...
    private static final String VIDEO_DIRECTORY_NAME = "Inspection";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_video_posts2);
